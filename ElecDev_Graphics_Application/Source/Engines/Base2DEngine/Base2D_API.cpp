...
#include "OpenGL/FontsGL.h"

//=============================================================================================================================================//
//  Rendering.																																   //
//=============================================================================================================================================//

void Base2DEngine::drawLine(float position1[2], float position2[2], float color[4])
{
...
void Base2DEngine::drawTriangleClear(float position1[2], float position2[2], float position3[2], float color[4])
{
	std::vector<VertexData> vertices =
	{
		VertexData(position1[0], position1[1], 0.0f, color[0], color[1], color[2], color[3], 0),
...
void Base2DEngine::drawTriangleFilled(float position1[2], float position2[2], float position3[2], float color[4])
{
	std::vector<VertexData> vertices =
	{
		VertexData(position1[0], position1[1], 0.0f, color[0], color[1], color[2], color[3], 0),
...
// Draw a clear quad.
void Base2DEngine::drawQuadClear(float position[2], float width, float height, float color[4])
{
	width /= 2;	height /= 2;
	std::vector<VertexData> vertices =
	{
...
// Draw a filled quad.
void Base2DEngine::drawQuadFilled(float position[2], float width, float height, float color[4])
{
	width /= 2;	height /= 2;
	std::vector<VertexData> vertices =
	{
...
void Base2DEngine::drawCircleClear(float coords[2], float radius, float color[4])
{
...
void Base2DEngine::drawCircleFilled(float coords[2], float radius, float color[4])
{
	glm::vec4 colorGLM(color[0], color[1], color[2], color[3]);
	glm::vec3 pos1(coords[0] - radius, coords[1] + radius, 0.f);
	glm::vec3 pos2(coords[0] + radius, coords[1] + radius, 0.f);
...
void Base2DEngine::drawText(std::string text, float coords[2], float color[4], float scale, std::string align)
{
...
void Base2DEngine::drawDemo(unsigned int loopCount)
{
	loopCount -= 1;
