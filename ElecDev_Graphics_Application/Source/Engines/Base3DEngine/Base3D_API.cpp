...
void Base3DEngine::drawQuadFilled3D(float position1[3], float position2[3], float position3[3], float position4[3], float color[4]) 
{
	//// Create the vertices.
...
void Base3DEngine::drawCuboidFilled(float position1[3], float position2[3], float position3[3], float position4[3], float depth, float color[4]) 
{
	//// Create the vertices.
	//Vertex* v1 = new VertexData(
	//	position1[0], position1[1], position1[2],
...
void Base3DEngine::drawDemo(unsigned int loopCount) 
{
	//loopCount -= 1;
