...
the EngineCore class.  This is the pointer type that will be used to point to all of the child classes and their
...
public:
	...
	EngineCore(GUIState* guiState, std::string contextName);
	~EngineCore();
	...
	void functionNotImplementedError(std::string functionName);	// This is called when a funtion in EngineCore is called but was not 
