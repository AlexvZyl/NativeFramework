...
static void initDistance(double &distance) {
    distance = SignedDistance::INFINITE_MSDF.distance;
}

static void initDistance(MultiDistance &distance) {
    distance.r = SignedDistance::INFINITE_MSDF.distance;
    distance.g = SignedDistance::INFINITE_MSDF.distance;
    distance.b = SignedDistance::INFINITE_MSDF.distance;
}
