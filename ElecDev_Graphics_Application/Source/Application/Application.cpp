...
void Application::setGuiTheme()
{
	...
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.30f, 0.30f, 0.37f, 1.00f);
	colors[ImGuiCol_ButtonActive] = ImVec4(0.44f, 0.44f, 0.57f, 1.00f);
	colors[ImGuiCol_Header] = ImVec4(0.24f, 0.24f, 0.27f, 1.00f);
	...
	colors[ImGuiCol_Tab] = ImVec4(0.14f, 0.41f, 0.42f, 0.46f);
	colors[ImGuiCol_TabHovered] = ImVec4(0.00f, 0.73f, 0.74f, 1.00f);
	colors[ImGuiCol_TabActive] = ImVec4(0.00f, 0.57f, 0.58f, 1.00f);
	colors[ImGuiCol_TabUnfocused] = ImVec4(0.14f, 0.41f, 0.42f, 0.46f);
	colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.00f, 0.57f, 0.58f, 1.00f);
	...
	colors[ImGuiCol_TableHeaderBg] = ImVec4(0.19f, 0.19f, 0.23f, 1.00f);
