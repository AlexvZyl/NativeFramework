...
void Application::setGuiTheme()
{
	...
	// Setup ImGui style.
	if(first) ImGui::StyleColorsDark();
	...
	if (first)
	{
		...
		colors[ImGuiCol_TextDisabled] = ImVec4(0.38f, 0.54f, 1.00f, 1.00f);
		...
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.06f, 0.06f, 0.07f, 0.60f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.80f, 0.80f, 0.83f, 0.31f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.81f, 0.81f, 0.88f, 0.31f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.77f, 0.77f, 0.92f, 0.31f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.38f, 0.54f, 1.00f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.80f, 0.80f, 0.83f, 0.31f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.80f, 0.80f, 0.83f, 0.31f);
		colors[ImGuiCol_Button] = ImVec4(0.30f, 0.30f, 0.36f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.40f, 0.40f, 0.47f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.54f, 0.54f, 0.62f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.24f, 0.25f, 0.30f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.34f, 0.35f, 0.42f, 1.00f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.43f, 0.46f, 0.54f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.06f, 0.06f, 0.07f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.06f, 0.06f, 0.07f, 1.00f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.38f, 0.54f, 1.00f, 1.00f);
		...
		colors[ImGuiCol_TabActive] = ImVec4(0.38f, 0.54f, 1.00f, 1.00f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.12f, 0.12f, 0.13f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.38f, 0.54f, 1.00f, 1.00f);
		colors[ImGuiCol_DockingPreview] = ImVec4(0.38f, 0.54f, 1.00f, 1.00f);
		colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.06f, 0.06f, 0.07f, 1.00f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.40f, 0.39f, 0.38f, 0.63f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.25f, 1.00f, 0.00f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.40f, 0.39f, 0.38f, 0.63f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.25f, 1.00f, 0.00f, 1.00f);
		colors[ImGuiCol_TableHeaderBg] = ImVec4(0.29f, 0.29f, 0.33f, 1.00f);
		...
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.38f, 0.54f, 1.00f, 0.50f);
