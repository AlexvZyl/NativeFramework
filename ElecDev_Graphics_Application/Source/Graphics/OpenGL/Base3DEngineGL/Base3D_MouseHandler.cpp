...
void Base3DEngineGL::mousePressLeft(float pixelCoords[2]) 
{
	...
	//glm::vec3 mouseWorldCoords = pixelCoordsToCameraVector(pixelCoords);
...
void Base3DEngineGL::mouseScrollEvent(float pixelCoords[2], float yOffset)
{
	...
	//glm::vec4 mouseWorldCoordsPre = pixelCoordsToCameraVector(pixelCoords);
	...
	//glm::vec4 mouseWorldCoordsPost = pixelCoordsToCameraVector(pixelCoords);
