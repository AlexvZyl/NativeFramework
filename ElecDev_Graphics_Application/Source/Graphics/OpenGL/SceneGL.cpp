...
void Scene::create2DBackground()
{
	...
	glm::vec3 pos5(0.0f, 0.0f, 0.99f);

	// Vertices.
	m_backgroundVAO->m_vertexCPU.emplace_back(VertexData(pos1, bgColor1, -1)); //  Top right.
	...
	m_backgroundVAO->m_vertexCPU.emplace_back(VertexData(pos5, bgColor2, -1)); //  Center.
	m_backgroundVAO->m_vertexCount += 5;

	// Indices.
	m_backgroundVAO->m_indexCPU.insert(m_backgroundVAO->m_indexCPU.end(), { 0,1,4,  1,4,2,  4,2,3,  0,4,3 });
	m_backgroundVAO->m_indexCount += 12;
