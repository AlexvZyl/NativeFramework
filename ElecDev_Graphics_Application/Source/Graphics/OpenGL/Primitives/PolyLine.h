...
public:
    ...
    PolyLine(std::vector<glm::vec2> vertices, VertexArrayObject<VertexData>* VAO, Entity* parent, float thickness = 0.014f, bool closed = false, glm::vec4 colour = {0.f, 0.f, 0.f, 1.f});
